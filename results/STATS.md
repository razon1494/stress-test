...
| binoculars_lite | paraphrase_t5 | 58.0% [50.0%, 66.0%] | 3.3% [0.7%, 6.7%] |
...
| fast_detect_gpt | paraphrase_t5 | 64.7% [56.7%, 72.0%] | 2.7% [0.7%, 5.3%] |
...
| perplexity | paraphrase_t5 | 62.7% [54.7%, 70.0%] | 0.0% [0.0%, 0.0%] |
...
| roberta_openai | paraphrase_t5 | 38.0% [30.7%, 46.0%] | 9.3% [4.7%, 14.0%] |
...
| stylometric_gbm | paraphrase_t5 | 46.7% [38.7%, 54.7%] | 4.7% [1.3%, 8.0%] |
...
| tfidf_logreg | paraphrase_t5 | 54.0% [46.0%, 62.0%] | 6.7% [2.7%, 11.3%] |
...
| paraphrase_t5 | -3.7% | 21 / 32 | 0.1712 | 1.0000 |
...
| launder_lite | -6.7% | 19 / 39 | 0.0141 | 0.0846 |
| light_human_edit | +1.3% | 7 / 3 | 0.3418 | 1.0000 |
| paraphrase_t5 | -4.0% | 20 / 32 | 0.1318 | 0.6589 |
...
| paraphrase_t5 | +13.0% | 60 / 21 | 0.0001 | 0.0013 * |
...
| launder_lite | -4.0% | 29 / 41 | 0.1874 | 0.1874 |
| light_human_edit | +17.3% | 56 / 4 | 0.0001 | 0.0013 * |
| paraphrase_t5 | +6.3% | 53 / 34 | 0.0521 | 0.1042 |
...
| paraphrase_t5 | +3.7% | 48 / 37 | 0.2758 | 1.0000 |
| roundtrip_fr | +0.0% | 24 / 24 | 1.0000 | 1.0000 |
| typo | -24.0% | 13 / 139 | 0.0001 | 0.0013 * |
| whitespace_noise | +1.9% | 41 / 31 | 0.2835 | 1.0000 |
...
| contraction_expand | +1.3% | 12 / 5 | 0.1461 | 1.0000 |
...
| paraphrase_t5 | -0.3% | 32 / 33 | 1.0000 | 1.0000 |
...
| paraphrase_t5 | +16.7% | 63 / 13 | 0.0001 | 0.0013 * |
...
| launder_lite | -4.0% | 26 / 38 | 0.1716 | 0.3432 |
| light_human_edit | +15.0% | 51 / 6 | 0.0001 | 0.0013 * |
| paraphrase_t5 | +10.0% | 50 / 20 | 0.0004 | 0.0016 * |
| roundtrip_fr | +10.3% | 48 / 17 | 0.0002 | 0.0013 * |
| typo | +1.5% | 69 / 61 | 0.5352 | 0.5352 |
| whitespace_noise | +7.8% | 68 / 27 | 0.0001 | 0.0013 * |
| zero_width | -6.1% | 33 / 65 | 0.0020 | 0.0060 * |
...
| launder_lite | -6.3% | 36 / 55 | 0.0595 | 0.2380 |
| light_human_edit | +8.0% | 33 / 9 | 0.0003 | 0.0021 * |
| paraphrase_t5 | +7.3% | 56 / 34 | 0.0255 | 0.1275 |
...
| paraphrase_t5 | +17.0% | 66 / 15 | 0.0001 | 0.0013 * |
...
| paraphrase_t5 | +10.3% | 51 / 20 | 0.0003 | 0.0013 * |
...
| paraphrase_t5 | -6.7% | 34 / 54 | 0.0418 | 0.2090 |
...
| paraphrase_t5 | -9.3% | 31 / 59 | 0.0032 | 0.0192 * |
...
| launder_lite | -2.3% | 42 / 49 | 0.5317 | 0.9459 |
| light_human_edit | -7.0% | 21 / 42 | 0.0113 | 0.0339 * |
| paraphrase_t5 | -2.7% | 43 / 51 | 0.4730 | 0.9459 |
